...
<head>
    ...
    <meta name="description" content="View and manage reports submitted by students about dormitory issues." />
    <meta name="keywords" content="admin reports, student issues, dormitory management, iQamaty" />
    <title>iQamaty - Reports Admin</title>
    ...
    <link rel="stylesheet" href="/iQamaty_10/public/adminassets/css/reports.css" />
        ...
        <h1 class="p-relative">Reports</h1>
            ...
            <div class="d-flex align-center justify-between mb-20">
                <input 
                    type="text" 
                    id="search-bar" 
                    placeholder="Search by reporter or report name..." />
                <div class="filters">
...
<script src="/iQamaty_10/public/adminassets/js/reports.js"></script>
</body>
</html>
